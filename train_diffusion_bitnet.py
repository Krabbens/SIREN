...
def main():
    ...
    parser.add_argument("--checkpoint_dir", default="checkpoints_diffusion_finetune")
    parser.add_argument("--pretrained_ckpt", default="checkpoints_diffusion/best_model.pt")
