...
def main():
    ...
    micro_ckpt = "checkpoints/checkpoints_micro_encoder/best_model.pt"
    vocoder_ckpt = "checkpoints/checkpoints_bitnet/best_model.pt"
    adapter_ckpt = "checkpoints/checkpoints_adapter/checkpoint_epoch9.pt"  # Use older non-upsampler version
    diffusion_ckpt = "checkpoints/checkpoints_diffusion/best_model.pt"
