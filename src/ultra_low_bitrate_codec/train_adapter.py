...
def main():
    ...
    parser.add_argument("--micro_checkpoint", default="checkpoints/checkpoints_micro_encoder/best_model.pt")
    parser.add_argument("--vocoder_checkpoint", default="checkpoints/checkpoints_bitnet/best_model.pt")
    ...
    writer = SummaryWriter("checkpoints/checkpoints_adapter/tensorboard")
    os.makedirs("checkpoints/checkpoints_adapter", exist_ok=True)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(adapter.state_dict(), f"checkpoints/checkpoints_adapter/checkpoint_epoch{epoch}.pt")
        
    torch.save(adapter.state_dict(), "checkpoints/checkpoints_adapter/final_model.pt")
