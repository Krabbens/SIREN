...
Usage:
    python train_bit_encoder.py --teacher_checkpoint checkpoints_micro_encoder/best_model.pt
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="checkpoints_bit_encoder")
