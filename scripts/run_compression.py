...
def main():
    ...
    parser.add_argument("--input", type=str, default="inference_results/jakubie_57000_compressed.pt")
    parser.add_argument("--output", type=str, default="inference_results/jakubie_ac.bin")
