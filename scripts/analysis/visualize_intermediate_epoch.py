...
def main():
    ...
    # Load weights for encoder parts (assuming they are in checkpoints/checkpoints_ultra200bps_large/step_14500)
    orig_ckpt_dir = "checkpoints/checkpoints_ultra200bps_large/step_14500"
