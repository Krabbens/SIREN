...
Usage:
    python train_bitnet.py --teacher_checkpoint checkpoints/checkpoints_stable/step_87000
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="checkpoints/checkpoints_bitnet",
