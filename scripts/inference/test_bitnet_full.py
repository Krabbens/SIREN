...
def main():
    ...
    input_audio = "data/jakubie_16k.wav"
    siren_checkpoint = "checkpoints/checkpoints_stable/step_87000"
    bitnet_checkpoint = "checkpoints/checkpoints_bitnet/checkpoint_epoch110.pt"
    config_path = "ultra_low_bitrate_codec/configs/sub100bps.yaml"
    output_dir = "outputs/bitnet_jakubie_results"
