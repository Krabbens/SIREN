...
def main():
    ...
    parser.add_argument("--bitnet_ckpt", default="checkpoints/checkpoints_ultra200bps_large/step_14500")
    parser.add_argument("--diffusion_ckpt", default="checkpoints/checkpoints_diffusion_finetune/best_model.pt")
